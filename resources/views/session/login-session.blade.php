        ...
        <div class="row justify-content-center">
          <div class="col-xl-4 col-lg-5 col-md-6">
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1">
              <small class="text-muted">Mot de passe oublié ? <a href="/login/forgot-password" style="color: #000080; font-weight: bold;">Réinitialiser ici</a>
</small>

              <p class="mb-4 text-sm mx-auto">
                Vous n'avez pas de compte ?
              <a href="register" style="color: #000080; font-weight: bold;">S'inscrire</a>
              </p>
            </div>
          </div>
        </div>
